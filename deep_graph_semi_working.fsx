...
module User =
    ...
    type UserAccount =
        ...
        static member additionalDeails_ = (fun a -> a.AdditionalDetails), (fun b a -> { a with AdditionalDetails = b })
        // static member patientAccountDetails_ = UserAccount.additionalDeails_ >-> AccountDetails.patientAccountDetails_
        static member dateOfBirth_ = (AccountDetails.patientAccountDetails_ >?> PatientAccountDetailsB.dateOfBirth_)
...
let testAccountDetails = get User.UserAccount.additionalDeails_ account

// let testPatientAccountDetails = get User.UserAccount.patientAccountDetails_ account

let getAccountDbo = get User.UserAccount.dateOfBirth_ account
let getAccountDetailsDob = get User.PatientAccountDetailsB.dateOfBirth_ patientAccountDetails
